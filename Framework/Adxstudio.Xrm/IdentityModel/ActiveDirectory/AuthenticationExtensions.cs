...
namespace Adxstudio.Xrm.IdentityModel.ActiveDirectory
{
	...
	public static class AuthenticationExtensions
	{
		...
		/// <summary>
		/// Converts an ADAL-style resource into the equivalent MSAL scope.
		/// </summary>
		/// <param name="resource">The target resource.</param>
		...
		/// <summary>
		/// Retrieves the confidential client application for the certificate and settings, creating it on first use.
		/// </summary>
		/// <param name="certificate">The application's certificate</param>
